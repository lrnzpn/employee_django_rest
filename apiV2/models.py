...
class Employee(models.Model):
  ...
  job_email = models.EmailField(max_length=100, blank=True)
  salary = models.IntegerField(default=0)
  # benefits details
  sss = models.CharField(max_length=40, blank=True)
  philhealth = models.CharField(max_length=40, blank=True)
  pagibig = models.CharField(max_length=40, blank=True)
  bir = models.CharField(max_length=40, blank=True)
