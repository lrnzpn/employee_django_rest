# Generated by Django 3.0.8 on 2020-07-16 10:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_email', models.EmailField(blank=True, max_length=255)),
                ('salary', models.IntegerField(default=0)),
                ('sss', models.CharField(blank=True, max_length=255)),
                ('philhealth', models.CharField(blank=True, max_length=255)),
                ('pagibig', models.CharField(blank=True, max_length=255)),
                ('bir', models.CharField(blank=True, max_length=255)),
